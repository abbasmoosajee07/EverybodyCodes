...
print(f"Quest 1: After {earth_mined_p1[-1][0]} iterations, earth mined is {earth_mined_p1[-1][1]}")
# 139- wrong ans, correct length, Correct first digit
# 135- Correct Answer

earth_mined_p2, _ = mine_earth(input_data_p2)
print(f"Quest 2: After {earth_mined_p2[-1][0]} iterations, earth mined is {earth_mined_p2[-1][1]}")
# 2646 Correct Ans

earth_mined_p3, _ = mine_earth(input_data_p3, royal_lands = True)
print(f"Quest 3: After {earth_mined_p3[-1][0]} iterations, earth mined is {earth_mined_p3[-1][1]}")
